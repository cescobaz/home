...
function runServer () {
  ...
  const kitchenLed2 = makeLedThing({ ping: 9, identifier: 'kitchen-led-green-2', name: 'kitchen led green 2', isLight: true })
  const kitchenLed3 = makeLedThing({ ping: 10, identifier: 'kitchen-led-yellow-3', name: 'kitchen led yellow 3', isLight: true })
  const kitchenLed4 = makeLedThing({ ping: 22, identifier: 'kitchen-led-yellow-4', name: 'kitchen led yellow 4', isLight: true })
  const kitchenLed5 = makeLedThing({ ping: 17, identifier: 'kitchen-led-red-5', name: 'kitchen led red 5', isLight: true })
  const kitchenLed6 = makeLedThing({ ping: 4, identifier: 'kitchen-led-red-6', name: 'kitchen led red 6', isLight: true })
