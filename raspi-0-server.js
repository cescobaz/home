...
function runServer () {
  ...
  const kitchenLamp = makeLedThing(24, 'kitchen-lamp-0', 'kitchen lamp', true)
  const kitchenBuzzer = makeLedThing(8, 'kitchen-buzzer-0', 'kitchen buzzer')
  const kitchenLed1 = makeLedThing(11, 'kitchen-led-green-1', 'kitchen led green 1', true)
  const kitchenLed2 = makeLedThing(9, 'kitchen-led-green-2', 'kitchen led green 2', true)
  const kitchenLed3 = makeLedThing(10, 'kitchen-led-yellow-3', 'kitchen led yellow 3', true)
  const kitchenLed4 = makeLedThing(22, 'kitchen-led-yellow-4', 'kitchen led yellow 4', true)
  const kitchenLed5 = makeLedThing(17, 'kitchen-led-red-5', 'kitchen led red 5', true)
  const kitchenLed6 = makeLedThing(4, 'kitchen-led-red-6', 'kitchen led red 6', true)
