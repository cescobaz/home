...
function runServer () {
  ...
  const kitchenLed1 = makeLedThing(4, 'kitchen-led-green-1', 'kitchen led green 1')
  const kitchenLed2 = makeLedThing(17, 'kitchen-led-green-2', 'kitchen led green 2')
  const kitchenLed3 = makeLedThing(22, 'kitchen-led-yellow-3', 'kitchen led yellow 3')
  const kitchenLed4 = makeLedThing(10, 'kitchen-led-yellow-4', 'kitchen led yellow 4')
  const kitchenLed5 = makeLedThing(9, 'kitchen-led-red-5', 'kitchen led red 5')
  const kitchenLed6 = makeLedThing(11, 'kitchen-led-red-6', 'kitchen led red 6')
